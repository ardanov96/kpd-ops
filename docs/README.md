...
> - `00N-...md` → Sprint ke-N (planning + task list)
> - `xxx-modul-...md` → Brief spesifik modul (schema, workflow, referensi)
...
| `001-sprint-modul-inventaris.md` | Sprint 1 — Modul Inventaris | ✅ |
...
| `010-spec-schema.md` | Schema SQL final (gabungan 3 migration) | ✅ |
...
2. **Cek referensi schema** → buka `010-spec-schema.md`
3. **Paham kenapa keputusan X diambil** → buka `030-decision-log.md`
